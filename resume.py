...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.textEdit.setGeometry(QtCore.QRect(30, 30, 221, 31))
        self.textEdit.setObjectName("textEdit")
        self.textEdit_2 = QtWidgets.QTextEdit(Form)
        self.textEdit_2.setGeometry(QtCore.QRect(30, 90, 221, 31))
        self.textEdit_2.setObjectName("textEdit_2")
        self.textEdit_3 = QtWidgets.QTextEdit(Form)
        self.textEdit_3.setGeometry(QtCore.QRect(30, 160, 221, 71))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "Your resume"))
